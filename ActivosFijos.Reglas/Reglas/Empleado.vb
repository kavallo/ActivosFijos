...
Public Class Empleado
  ...
  'Public ReadOnly Property EstadoActualString(ByVal _patrono As Patrono) As String
  '  Get
  '    If UltimoContrato(_patrono) Is Nothing Then
  '      Return String.Empty
  '    Else
  '      If UltimoContrato(_patrono).Activo Then
  '        Return "Activo, Fecha: " + UltimoContrato(_patrono).Contra_Desde + ", Seccion: " + UltimoContrato(_patrono).PardetDepartamento.PardetPadre.Pardet_Descripcion + ", Cargo: " + UltimoContrato(_patrono).Cargo.Cargo_Descripcion
  '      Else
  '        If UltimoContrato(_patrono).PardetMotivoSalida IsNot Nothing Then
  '          Return UltimoContrato(_patrono).PardetMotivoSalida.Descripcion + ", de: " + UltimoContrato(_patrono).Contra_Desde + " a " + UltimoContrato(_patrono).Contra_Hasta + ", Seccion: " + UltimoContrato(_patrono).PardetDepartamento.PardetPadre.Pardet_Descripcion + ", Cargo: " + UltimoContrato(_patrono).Cargo.Cargo_Descripcion
  '        Else
  '          Return ""
  '        End If
  '      End If
  ...
  '  Private mNumeroCargasUtilidad As Integer = -1
  '  Public ReadOnly Property NumeroCargasUtilidad(_desde As DateTime, _hasta As DateTime) As Integer
  '    Get
  '      If mNumeroCargasUtilidad = -1 Then
  '        Dim dsResult As New DataTable
  '        Dim bResult As Boolean
  '        With OperadorDatos
  '          .AgregarParametro("@accion", "ccu")
  ...
  '          mNumeroCargasUtilidad = (dsResult.Rows(0)("Cargas"))
  '        Else
  '          mNumeroCargasUtilidad = 0
  '        End If
  '      End If
  '      Return mNumeroCargasUtilidad
  '    End Get
  '  End Property
  '#End Region
  ...
  'Public ReadOnly Property ContratoActivo(ByVal _patrono As Patrono) As Contrato
  '  Get
  '    Return BuscarContratoActivo(_patrono)
  '  End Get
  'End Property

  'Public ReadOnly Property UltimoContrato(ByVal _patrono As Patrono) As Contrato
  '  Get
  '    Return BuscarUltimoContrato(_patrono)
  '  End Get
  'End Property

  'Public Function BuscarContratoActivo(ByVal _patrono As Patrono) As Contrato
  '  Dim dsResult As New DataTable
  '  Dim bResult As Boolean
  ...
  '    Dim patcodigo As Integer
  '    Dim consecuencial As Integer
  '    percodigo = CInt(dsResult.Rows(0)("Entida_Codigo"))
  '    patcodigo = CInt(dsResult.Rows(0)("Patron_codigo"))
  ...
  'Public Function BuscarUltimoContrato(ByVal _patrono As Patrono) As Contrato
  '  Dim dsResult As New DataTable
  '  Dim bResult As Boolean
  '  Dim oResult As Contrato = Nothing
  ...
  '#Region "Areas Aplicadas"
  '  Private mAplicaciones As AplicacionEmpleadoList = Nothing

  '  Public ReadOnly Property Aplicaciones As AplicacionEmpleadoList
  '    Get
  '      If mAplicaciones Is Nothing Then
  '        mAplicaciones = AplicacionEmpleadoList.ObtenerListaxEmpleado(Me)
  '      End If
  '      Return mAplicaciones
  '    End Get
  '  End Property

  '  Private mAplicacionesEliminadas As AplicacionEmpleadoList = Nothing

  '  Public ReadOnly Property AplicacionesEliminadas As AplicacionEmpleadoList
  '    Get
  '      If mAplicacionesEliminadas Is Nothing Then
  '        mAplicacionesEliminadas = New AplicacionEmpleadoList
  '      End If
  '      Return mAplicacionesEliminadas
  '    End Get
  '  End Property
  '#End Region
  ...
  Public Overridable Function Guardar() As Boolean
    ...
    For Each _ident As EntidadIdentificacion In Entidadnatural.Entidad.Identificaciones
      Select Case _ident.Pardet_TipoidentificacionEnum
        Case Enumerados.enumTipoIdentificacion.Cedula
          If String.IsNullOrWhiteSpace(_ident.Identi_Numero) Then
    ...
    'Dim _haytelefonocasa As Boolean = False
    'For Each _ident As EntidadDatos In Entidadnatural.Entidad.OtrosDatos
    '  If _ident.Parame_Tipodatos = Enumerados.EnumParametros.TipoTelefono And _ident.Pardet_Tipodatos = Enumerados.enumTipoTelefono.Domicilio Then
    '    If String.IsNullOrWhiteSpace(_ident.Entdat_Descripcion) Then
    '      Throw New Exception("El teléfono de domicilio ingresado no es válido")
    '    End If
    '    _haytelefonocasa = True
    '  End If
    'Next
    'If Not _haytelefonocasa Then
    '  Throw New Exception("No ha ingresado el teléfono de domicilio")
    'End If

    'Dim _haydireccioncasa As Boolean = False
    'For Each _ident As EntidadDireccion In Entidadnatural.Entidad.Direcciones
    '  If _ident.Pardet_Tipodireccion = Enumerados.enumTipoDireccion.Domicilio Then
    '    If String.IsNullOrWhiteSpace(_ident.Direcc_Calleprincipal) Then
    '      Throw New Exception("La dirección de domicilio ingresada no es válida")
    '    End If
    '    _haydireccioncasa = True
    '  End If
    'Next
    'If Not _haydireccioncasa Then
    '  Throw New Exception("No ha ingresado la dirección de domicilio")
    'End If
    ...
    End If
    If bReturn Then
      'For Each _Aplicacion As AplicacionEmpleado In AplicacionesEliminadas
      '  _Aplicacion.Entida_Codigo = Entida_Codigo
      '  If Not _Aplicacion.Eliminar Then
      '    bReturn = False
      '    Exit For
      '  End If
      'Next

      'For Each _Aplicacion As AplicacionEmpleado In Aplicaciones
      '  _Aplicacion.Entida_Codigo = Entida_Codigo
      '  If Not _Aplicacion.Guardar Then
      '    bReturn = False
      '    Exit For
      '  End If
      'Next
  ...
  Public Overridable Sub AceptarCambios()
    ...
    'For Each _Aplicacion As AplicacionEmpleado In Aplicaciones
    '  _Aplicacion.AceptarCambios()
    'Next

    'mAplicacionesEliminadas = Nothing
  End Sub
...
Public Class EmpleadoList
  ...
  'Public Function ListaContratoActivoSeleccionados(ByVal _patrono As Patrono) As ContratoList

  '  Dim _contratos As New ContratoList
  '  For Each _empleado As Empleado In Me
  '    If _empleado.Seleccionado Then
  '      _contratos.Add(_empleado.ContratoActivo(_patrono))
  '    End If
  '  Next
  '  Return _contratos
  'End Function

  'Public Function ListaUltimoContratoSeleccionados(ByVal _patrono As Patrono) As ContratoList

  '  Dim _contratos As New ContratoList
  '  For Each _empleado As Empleado In Me
  '    If _empleado.Seleccionado Then
  '      _contratos.Add(_empleado.UltimoContrato(_patrono))
  '    End If
  '  Next
  '  Return _contratos
  'End Function
  ...
  Public Shared Function ObtenerLista(ByVal _OperadorDatos As OperadorDatos, Optional ByVal _Nombre As String = "", Optional ByVal _Codigo As Integer = 0, Optional ByVal _Cedula As String = "", Optional ByVal _Edad As Integer = 0, Optional ByVal _Mayorque As Boolean = True) As EmpleadoList
  ...
  'Public Shared Function ObtenerPersonasReclutamiento(ByVal _OperadorDatos As OperadorDatos, Optional ByVal _PardetArea As WWTSParametroDet = Nothing, Optional ByVal _PardetSectorDomicilio As WWTSParametroDet = Nothing, Optional ByVal _AspiracionMinimo As Decimal = 0, Optional ByVal _AspiracionMaximo As Decimal = 0, Optional ByVal _Bachiller As String = Nothing, Optional ByVal _PardetTitulo As WWTSParametroDet = Nothing, Optional ByVal _PardetGenero As WWTSParametroDet = Nothing, Optional ByVal nivel_academico As Integer = 0, Optional ByVal _filtro As String = "") As EmpleadoList
  Public Shared Function ObtenerPersonasReclutamiento(ByVal _OperadorDatos As OperadorDatos, Optional ByVal _PardetArea As WWTSParametroDet = Nothing, Optional ByVal _PardetSectorDomicilio As WWTSParametroDet = Nothing, Optional ByVal _AspiracionMinimo As Decimal = 0, Optional ByVal _AspiracionMaximo As Decimal = 0, Optional ByVal _PardetGenero As WWTSParametroDet = Nothing, Optional ByVal nivel_academico As Integer = 0, Optional ByVal _filtro As String = "") As EmpleadoList
    Dim oResult As New EmpleadoList
    Dim bReturn As Boolean
    Dim dsResult As New DataTable
    With _OperadorDatos
      ...
      End If
      If _AspiracionMaximo <> 0 Then
        .AgregarParametro("@AspiracionMinimo", _AspiracionMinimo)
        .AgregarParametro("@AspiracionMaximo", _AspiracionMaximo)
      End If
      'If _Bachiller IsNot Nothing Then
      '  .AgregarParametro("@Parame_Bachiller", 1)
      '  '.AgregarParametro("@Pardet_Bachiller", _PardetBachiller.Pardet_Secuencia)
      'End If
      'If _PardetTitulo IsNot Nothing Then
      '  .AgregarParametro("@Parame_Titulo", 1) '_PardetTitulo.Parame_Codigo)
      '  .AgregarParametro("@Pardet_Titulo", _PardetTitulo.Pardet_Secuencia)
      'End If
      .AgregarParametro("@nivel_academico", nivel_academico)
      If _PardetGenero IsNot Nothing Then
        .AgregarParametro("@Parame_Sexo", _PardetGenero.Parame_Codigo)
        .AgregarParametro("@Pardet_Sexo", _PardetGenero.Pardet_Secuencia)
      End If
