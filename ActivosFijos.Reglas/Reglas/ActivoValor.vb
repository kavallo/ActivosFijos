...
Public Class ActivoValor
  ...
  <Infoware.Reportes.CampoReporteAtributo("Tipo Valoración", Infoware.Reportes.CampoReporteAtributo.EnumTipoDato.Texto, 100, True)> _
  Public ReadOnly Property TipoValoracionString() As String
    Get
      If PardetTipoValoracion Is Nothing Then
        Return String.Empty
      Else
        Return IIf(Pardet_TipoValoracion = Enumerados.enumTipoValoracion.Erogacion, " └─", "") + PardetTipoValoracion.Descripcion
      End If
    End Get
  End Property
  ...
  Public ReadOnly Property Costo() As String
    Get
      If Pardet_TipoValoracion = Enumerados.enumTipoValoracion.Erogacion Then
        Return "+" + ActVal_ValorErogacion.ToString("0.00")
      Else
  ...
  Public ReadOnly Property ValorDepreciable() As String
    Get
      Return (ActVal_Costo - ActVal_Salvamento).ToString("0.00")
    End Get
  End Property
  ...
  Public ReadOnly Property Remanente() As String
    Get
      Return (ActVal_Costo - ActVal_Salvamento - Depreciado).ToString("0.00")
    End Get
  End Property
  ...
  Public ReadOnly Property PeriodosDepreciables() As String
    Get
      If Pardet_TipoValoracion = Enumerados.enumTipoValoracion.Erogacion Then
        Return String.Empty
      End If
      Return ActVal_PeriodosDepreciables.ToString
    End Get
  End Property
