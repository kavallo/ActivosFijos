...
#End Region
  ...
  Sub buscar()
    ...
    If mInventario.EsNuevo Then
      ...
      For Each _activo As Activo In ActivoList.ObtenerLista(Sistema.OperadorDatos, "", "", "", "", Nothing, Nothing, "", Nothing, Nothing, Nothing, Me.CtlUbicacionActivo1.ParametroDet, Nothing, True, -1, Nothing, Nothing)
