...
Public Class crpFichaActivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ActivosFijos.Modulo.crpFichaActivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpFichaActivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpFichaActivo = New crpFichaActivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
