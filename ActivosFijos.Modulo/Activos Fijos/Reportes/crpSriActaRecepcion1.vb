...
Public Class crpSriActaRecepcion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpSriActaRecepcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ActivosFijos.Modulo.crpSriActaRecepcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpSriActaRecepcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpSriActaRecepcion = New crpSriActaRecepcion()
        rpt.Site = Me.Site
        Return rpt
    End Function
