...
Public Class crpTransaccionActivo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpTransaccionActivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ActivosFijos.Modulo.crpTransaccionActivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTransaccionActivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTransaccionActivo = New crpTransaccionActivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
