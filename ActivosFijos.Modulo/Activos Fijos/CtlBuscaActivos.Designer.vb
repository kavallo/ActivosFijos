...
Partial Class CtlBuscaActivos
    ...
    Me.cbotipofecha.Items.AddRange(New Object() {"Compra entre", "Ingreso entre", "Uso entre", "Baja entre", "Sin fecha de uso", "Con fecha de baja"})
    ...
    Me.txtcodigoaux.TipoTexto = Infoware.Controles.Base.EnumTipoTexto.Ninguno
    '
    'Label5
    '
