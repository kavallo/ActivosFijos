...
#Region "Eventos"
  ...
  'Private Sub FrmListaActivos_Exportar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Exportar
  '  'exportar
  '  Try
  ...
  '    With excelWorksheet
  '      .Range("A1").Value = "Nombre de Activo"
  ...
  '        .Cells(t, 1).Value = _Activo.NombreCompleto
  '        .Cells(t, 2).Value = _Activo.DireccionesString
  '        .Cells(t, 3).Value = _Activo.TelefonosString
  '        .Cells(t, 4).Value = _Activo.EmailsString
  '        .Cells(t, 5).Value = _Activo.TelefonosString
  '      Next
