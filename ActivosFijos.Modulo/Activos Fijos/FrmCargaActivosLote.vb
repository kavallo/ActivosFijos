...
#End Region
  ...
  Sub GenerarExcelActivos(datos As PlantillaActivoList)
    Try
      ...
      'excelApp.Quit()
      Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga de Activos en Lote")
...
#End Region
  ...
  Private Sub btnGenerarPlantillaval_Click(sender As System.Object, e As System.EventArgs) Handles btnGenerarPlantillaval.Click
    Dim datos As New PlantillaValoracionList
    datos.Add(New PlantillaValoracion(Sistema.OperadorDatos))
    GenerarExcelValoracion(datos)
  End Sub

  Sub GenerarExcelValoracion(datos As PlantillaValoracionList)
    Try
      ...
      'excelWorksheet.PrintPreview()
      'excelApp.Quit()
      Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga de Valoraciones en Lote")
    Catch ex As Exception
      MsgBox("No se puede exporta a Microsoft Excel. " & ex.Message, MsgBoxStyle.Critical, "Error")
    Finally
    End Try
  ...
  Private Sub btncargarplantillaval_Click(sender As System.Object, e As System.EventArgs) Handles btncargarplantillaval.Click
    Dim ArchivoPlantilla As String = ""
    OpenFileDialog1.FileName = ""
    OpenFileDialog1.Filter = "Archivo Microsoft Excel (*.xls; *.xlsx)|*.xls; *.xlsx|Todos los archivos (*.*)|*.*"
    OpenFileDialog1.FilterIndex = 1
    ...
    Try
      ...
      With excelWorksheet
        ...
        While Not .Cells(fila, 2).value = ""
          ...
          Try
            Me.lblregistroval.Text = String.Format("{0} registros leidos", (fila - 1).ToString)
            Application.DoEvents()
        ...
        Me.bscargarval.DataSource = _lote
        Me.dgcargarval.AutoDiscover()
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          ...
          For Each _plantilla As PlantillaValoracion In _lote
            ...
            Else
              fila += 1
              Me.lblregistroval.Text = String.Format("{0} registros guardados", (fila - 1).ToString)
              Application.DoEvents()
            End If
          Next
          ...
          If _loteerror.Count > 0 Then
            ...
            GenerarExcelValoracion(_loteerror)
          Else
            MsgBox("Proceso terminado satisfactoriamente", MsgBoxStyle.Information, "Información")
          End If
