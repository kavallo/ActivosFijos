...
#Region "Componentes"
  ...
  Private Sub btnelimcomp_Click(sender As System.Object, e As System.EventArgs) Handles btnelimcomp.Click
    ...
    If MsgBox("¿Está seguro que desea eliminar este componente?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
      'If CType(Me.bscomponentes.Current, ActivoComponente).Eliminar Then
...
#End Region
  ...
  Private Sub pnlubicacionnuevo_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles pnlubicacionnuevo.Paint
