...
#Region "Guardar y Eliminar"
  ...
  Private Function Guardar_datos() As Boolean
    ...
    Try
      ...
      If CtlActivo1.Guardar Then
        Auditoria.Registrar_Auditoria(Restriccion, IIf(_esnuevo, Enumerados.enumTipoAccion.Adicion, Enumerados.enumTipoAccion.Modificacion), mActivo.Descripcion)
  ...
  Private Sub FrmMantenimientoActivo_Eliminar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Eliminar
    ...
    If mActivo.Eliminar() Then
      Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Eliminacion, mActivo.Descripcion)
      Activos.RemoveCurrent()
      Me.Close()
    Else
      'Activos.CancelEdit()
