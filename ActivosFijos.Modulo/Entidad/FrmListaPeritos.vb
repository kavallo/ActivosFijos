...
#Region "Eventos"
  ...
  'Private Sub FrmListaPeritos_Exportar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Exportar
  '  'exportar
  '  Try
  ...
  '    With excelWorksheet
  '      .Range("A1").Value = "Nombre de Perito"
  ...
  '      Dim t As Integer = 0
  '      For Each _Perito As Perito In mPeritos
  '        .Cells(t, 1).Value = _Perito.NombreCompleto
  '        .Cells(t, 2).Value = _Perito.DireccionesString
  '        .Cells(t, 3).Value = _Perito.TelefonosString
  '        .Cells(t, 4).Value = _Perito.EmailsString
  '        .Cells(t, 5).Value = _Perito.TelefonosString
  '      Next
